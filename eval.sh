...
# python eval.py --codec=mpeg4 --tracker_type=deep --tracker_iou_thres=0.1 --detector_interval=15 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-10-23_09-25-34/model_final.pth
# python eval.py --codec=mpeg4 --tracker_type=deep --tracker_iou_thres=0.1 --detector_interval=15 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-10-23_09-25-34/model_highest_iou.pth
# python eval.py --codec=mpeg4 --tracker_type=deep --tracker_iou_thres=0.1 --detector_interval=15 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-10-23_09-25-34/model_lowest_loss.pth
#
...
# python eval.py --codec=mpeg4 --tracker_type=deep --tracker_iou_thres=0.1 --detector_interval=15 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-10-30_02-47-42/model_final.pth
# python eval.py --codec=mpeg4 --tracker_type=deep --tracker_iou_thres=0.1 --detector_interval=15 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-10-30_02-47-42/model_highest_iou.pth
# python eval.py --codec=mpeg4 --tracker_type=deep --tracker_iou_thres=0.1 --detector_interval=15 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-10-30_02-47-42/model_lowest_loss.pth
#
...
# python eval.py --codec=h264 --vector_type=p --tracker_type=deep --tracker_iou_thres=0.1 --detector_interval=15 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-10-29_09-35-25/model_final.pth
# python eval.py --codec=h264 --vector_type=p --tracker_type=deep --tracker_iou_thres=0.1 --detector_interval=15 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-10-29_09-35-25/model_highest_iou.pth
# python eval.py --codec=h264 --vector_type=p --tracker_type=deep --tracker_iou_thres=0.1 --detector_interval=15 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-10-29_09-35-25/model_lowest_loss.pth
#
