...
#
# python eval.py --codec=h264 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=20 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-08_18-01-19/model_highest_iou.pth
# python eval.py --codec=h264 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=15 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-08_18-01-19/model_highest_iou.pth
# python eval.py --codec=h264 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=10 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-08_18-01-19/model_highest_iou.pth
# python eval.py --codec=h264 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=8 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-08_18-01-19/model_highest_iou.pth
# python eval.py --codec=h264 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=6 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-08_18-01-19/model_highest_iou.pth
# python eval.py --codec=h264 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=4 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-08_18-01-19/model_highest_iou.pth
# python eval.py --codec=h264 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=2 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-08_18-01-19/model_highest_iou.pth

########################### Deep Dense Experiments with some new models and corrected h264 model ###########################

# old network (with maxpool) but corrected fine tuning on the right codec (h264)
# python eval.py --codec=h264 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=20 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-12_05-17-34/model_highest_iou.pth --repeats=1
# python eval.py --codec=h264 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=15 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-12_05-17-34/model_highest_iou.pth --repeats=1
# python eval.py --codec=h264 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=10 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-12_05-17-34/model_highest_iou.pth --repeats=1
# python eval.py --codec=h264 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=8 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-12_05-17-34/model_highest_iou.pth --repeats=1
# python eval.py --codec=h264 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=6 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-12_05-17-34/model_highest_iou.pth --repeats=1
# python eval.py --codec=h264 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=4 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-12_05-17-34/model_highest_iou.pth --repeats=1
# python eval.py --codec=h264 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=2 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-12_05-17-34/model_highest_iou.pth --repeats=1

# new model without maxpool on mpeg
# python eval.py --codec=mpeg4 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=20 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-12_03-38-57/model_highest_iou.pth --repeats=1
# python eval.py --codec=mpeg4 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=15 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-12_03-38-57/model_highest_iou.pth --repeats=1
# python eval.py --codec=mpeg4 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=10 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-12_03-38-57/model_highest_iou.pth --repeats=1
# python eval.py --codec=mpeg4 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=8 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-12_03-38-57/model_highest_iou.pth --repeats=1
# python eval.py --codec=mpeg4 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=6 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-12_03-38-57/model_highest_iou.pth --repeats=1
# python eval.py --codec=mpeg4 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=4 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-12_03-38-57/model_highest_iou.pth --repeats=1
# python eval.py --codec=mpeg4 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=2 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-12_03-38-57/model_highest_iou.pth --repeats=1

# new model without maxpool on h264 (no yet trained)
#python eval.py --codec=h264 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=20 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-12_03-38-57/model_highest_iou.pth --repeats=1
#python eval.py --codec=h264 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=15 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-12_03-38-57/model_highest_iou.pth --repeats=1
#python eval.py --codec=h264 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=10 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-12_03-38-57/model_highest_iou.pth --repeats=1
#python eval.py --codec=h264 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=8 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-12_03-38-57/model_highest_iou.pth --repeats=1
#python eval.py --codec=h264 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=6 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-12_03-38-57/model_highest_iou.pth --repeats=1
#python eval.py --codec=h264 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=4 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-12_03-38-57/model_highest_iou.pth --repeats=1
#python eval.py --codec=h264 --tracker_type=deep --mvs_mode=dense --tracker_iou_thres=0.1 --detector_interval=2 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]} --gpu=$GPU --deep_tracker_weights_file=models/tracker/2019-11-12_03-38-57/model_highest_iou.pth --repeats=1
...
#
# python eval.py --codec=h264 --vector_type=pb --scale=0.25 --tracker_type=baseline --tracker_iou_thres=0.1 --detector_interval=20 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]}
# python eval.py --codec=h264 --vector_type=pb --scale=0.25 --tracker_type=baseline --tracker_iou_thres=0.1 --detector_interval=15 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]}
# python eval.py --codec=h264 --vector_type=pb --scale=0.25 --tracker_type=baseline --tracker_iou_thres=0.1 --detector_interval=10 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]}
# python eval.py --codec=h264 --vector_type=pb --scale=0.25 --tracker_type=baseline --tracker_iou_thres=0.1 --detector_interval=8 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]}
# python eval.py --codec=h264 --vector_type=pb --scale=0.25 --tracker_type=baseline --tracker_iou_thres=0.1 --detector_interval=6 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]}
# python eval.py --codec=h264 --vector_type=pb --scale=0.25 --tracker_type=baseline --tracker_iou_thres=0.1 --detector_interval=4 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]}
# python eval.py --codec=h264 --vector_type=pb --scale=0.25 --tracker_type=baseline --tracker_iou_thres=0.1 --detector_interval=2 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]}
#
# python eval.py --codec=h264 --vector_type=pb --scale=0.5 --tracker_type=baseline --tracker_iou_thres=0.1 --detector_interval=20 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]}
# python eval.py --codec=h264 --vector_type=pb --scale=0.5 --tracker_type=baseline --tracker_iou_thres=0.1 --detector_interval=15 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]}
# python eval.py --codec=h264 --vector_type=pb --scale=0.5 --tracker_type=baseline --tracker_iou_thres=0.1 --detector_interval=10 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]}
# python eval.py --codec=h264 --vector_type=pb --scale=0.5 --tracker_type=baseline --tracker_iou_thres=0.1 --detector_interval=8 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]}
# python eval.py --codec=h264 --vector_type=pb --scale=0.5 --tracker_type=baseline --tracker_iou_thres=0.1 --detector_interval=6 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]}
# python eval.py --codec=h264 --vector_type=pb --scale=0.5 --tracker_type=baseline --tracker_iou_thres=0.1 --detector_interval=4 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]}
# python eval.py --codec=h264 --vector_type=pb --scale=0.5 --tracker_type=baseline --tracker_iou_thres=0.1 --detector_interval=2 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]}
#
# python eval.py --codec=h264 --vector_type=pb --scale=0.75 --tracker_type=baseline --tracker_iou_thres=0.1 --detector_interval=20 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]}
# python eval.py --codec=h264 --vector_type=pb --scale=0.75 --tracker_type=baseline --tracker_iou_thres=0.1 --detector_interval=15 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]}
# python eval.py --codec=h264 --vector_type=pb --scale=0.75 --tracker_type=baseline --tracker_iou_thres=0.1 --detector_interval=10 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]}
# python eval.py --codec=h264 --vector_type=pb --scale=0.75 --tracker_type=baseline --tracker_iou_thres=0.1 --detector_interval=8 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]}
# python eval.py --codec=h264 --vector_type=pb --scale=0.75 --tracker_type=baseline --tracker_iou_thres=0.1 --detector_interval=6 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]}
# python eval.py --codec=h264 --vector_type=pb --scale=0.75 --tracker_type=baseline --tracker_iou_thres=0.1 --detector_interval=4 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]}
# python eval.py --codec=h264 --vector_type=pb --scale=0.75 --tracker_type=baseline --tracker_iou_thres=0.1 --detector_interval=2 --root_dir=$ROOT_DIR --sequences ${VAL_SEQUENCES[*]}
#
