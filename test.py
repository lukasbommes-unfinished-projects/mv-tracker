...
if __name__ == "__main__":
    ...
    tracker_deep = MotionVectorTrackerDeep(
        iou_threshold=tracker_iou_thres,
        weights_file="models/tracker/2019-10-29_09-07-07/model_highest_iou.pth", #  2019-10-23_09-25-34/model_final.pth", #2019-10-16_09-24-32/model_lowest_loss.pth,
        mvs_mode="upsampled",
        codec="mpeg4",
        stats=StatsH264UpsampledStaticSinglescale, #StatsMpeg4UpsampledStaticSinglescale,
        device=torch.device("cuda:0"))
    # tracker_deep = MotionVectorTrackerDeep(
    #     iou_threshold=tracker_iou_thres,
